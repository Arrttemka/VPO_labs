...
class TestGetDirectory(unittest.TestCase):
    ...
    @patch('builtins.input', side_effect=['H:/Мой диск/5 сем/VPO/VPO_LABS_TALAY/LAB_01_02'])
    def test_valid_directory(self, mock_input):
        result = get_directory('Enter directory path: ')
        self.assertEqual(result, 'H:/Мой диск/5 сем/VPO/VPO_LABS_TALAY/LAB_01_02')

    @patch('builtins.input', side_effect=['/path/to/nonexistent/directory', 'H:/Мой диск/5 сем/VPO/VPO_LABS_TALAY/LAB_01_02'])
    ...
    def test_find_html_files(self):
        ...
        directory = 'H:/Мой диск/5 сем/VPO/VPO_LABS_TALAY/LAB_01_02'
        extension = 'html'
        ...
        expected_count = 2  # Убедитесь, что это число верное
